...
class RelatorioForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $CAPITULO_R = new TCombo('CAPITULO_R');
        ...
        $CAPITULO_R -> addItems($valores_item_CAPITULO_R);
        
        
        
        $ITEM_R = new TCombo('ITEM_R');
        ...
        $ITEM_R ->addItems($valores_item_ITEM_R);
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $acao = new TAction(array('RelatorioForm','onClear'));//a ação de clear a ser chamada abaixo no message
